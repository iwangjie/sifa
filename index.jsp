	...
	<div class="main_bg1" style="overflow-y:hidden">
		...
		<div class="bt">
			...
			<div class="right">
				...
				<div class="right_one" style="width: 227px;height: 30px;">
		...
		<div class="content ">
			...
			<div class="you ">
				...
				<div class="you_right ">
					...
					<div class="lan_six">
						<p class="wd_p"><img src="./img/df_20.png">司法视窗
						...
						<div id="banner_tabs" class="flexslider" style="margin-top: -1px;">
                            <a href="#	" onclick="javascript:window.open('http://<%=locathostIp%>/sifa/ziye.jsp?sifaLdjh=33&id=155')"><img src="./img/video.jpg" style="width:100%;"/></a>
