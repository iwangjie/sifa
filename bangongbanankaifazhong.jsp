...
%>
		...
		<link rel="stylesheet" type="text/css" href="css/bangongbanankaifazhong.css" />
...
<div class="bt">
	...
	<div class="right">
		...
		<ul>
			...
			<li class="daohang hover_bg">
							<a href="#" onclick="javascript:window.open('http://<%=locathostIp%>/sifa/xuni.jsp')"><img src="img/menu_10.png"></a>
							<a href="#" onclick="javascript:window.open('http://<%=locathostIp%>/sifa/bangongbanankaifazhong.jsp')">办案平台</a>
						</li>
			<li class="daohang hover_bg">
...
<div class="section_bg">
    <div class="section">
            ...
            <div class="content">
             <img src="img/1_03.png" style="width: 100%">
            </div>
